...
export const HALLWAY_ROOM: RoomManifest = {
  ...
  bunnyStart: [4.0, -1.0],   // spawns near Bunny's Room door on the north wall
  ...
  objects: [
    ...
    // Mr. Bunny's bedroom — far right of north wall, near east corner
    {
      id:          "door-bedroom",
      type:        "furniture",
      label:       "Bunny's Room",
      position:    [4.5,  1.1, -2.0],
      size:        [0.9,  2.2,  0.15],
      color:       0x5C3D1E,
      interaction: { kind: "scene-change", targetRoomId: "tutorial" },
    },

    // Sibling's room — spread out to the left-centre of the north wall
    {
      id:          "door-sibling",
      type:        "furniture",
    ...
    // Midpoint of the two kids' door x-coordinates: (4.5 + -1.5) / 2 = 1.5
